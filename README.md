[![Tests](https://github.com/ArmasPyukkenen/python-core-homework/actions/workflows/python-app.yml/badge.svg?branch=master)](https://github.com/ArmasPyukkenen/python-core-homework/actions/workflows/python-app.yml)
